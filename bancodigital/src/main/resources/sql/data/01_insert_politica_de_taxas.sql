INSERT INTO politica_de_taxas (
    categoria,
    tarifa_manutencao_mensal_conta_corrente,
    rendimento_percentual_mensal_conta_poupanca,
	tarifa_manutencao_conta_internacional,
    limite_cartao_credito,
    limite_diario_debito,
    tarifa_seguro_viagem,
	tarifa_seguro_fraude,
	valor_apolice_fraude,
	valor_apolice_viagem
) VALUES
