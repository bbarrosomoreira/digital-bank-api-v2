...
public static final String CATEGORIA = "/categoria";
    ...
    public static final String INICIO_BUSCA_USUARIO = "Iniciando busca de usuário logado";
    public static final String SUCESSO_BUSCA_USUARIO = "Informações de usuário logado obtidas com sucesso";
