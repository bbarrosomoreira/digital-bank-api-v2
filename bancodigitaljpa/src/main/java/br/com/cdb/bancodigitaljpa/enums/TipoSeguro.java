...
public enum TipoSeguro {
	VIAGEM ("Seguro de Viagem", "Cobertura para despesas médicas no exterior, cancelamento de voos e extravio de bagagem.", "Clientes Comum e Super: opcional por R$50,00 por mês. Clientes Premium: isento de tarifa."),
